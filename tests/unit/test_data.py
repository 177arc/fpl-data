...
from fpldata.prepare import get_next_gw_counts
from fpldata.derive import calc_eps_for_next_gws, calc_player_fixture_stats, proj_to_gw, calc_eps
...
class TestProjToGw(unittest.TestCase):
    ...
    def test_proj_to_gw_for_normal_gw(self):
        players_gw_team_eps = (pd.read_csv(self.test_file)
                               ...
                               [['Name', 'Expected Points', 'Fixture Short Name FDR', 'Rel. Fixture Strength']])
